    ...
    public partial class SharedHeader : ComponentBase
    {
        ...
        private RenderFragment LightThemeIcon => builder =>
        {
            builder.AddMarkupContent(0, @"
                <svg width=""14px"" height=""15px"" viewBox=""0 0 32 32"" xmlns=""http://www.w3.org/2000/svg"">
        ...
        {
            builder.AddMarkupContent(0, @"
                <svg width=""14px"" height=""15px"" viewBox=""0 0 36 36"" xmlns=""http://www.w3.org/2000/svg"">
