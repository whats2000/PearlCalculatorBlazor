...
public partial class SharedHeader
{
                ...
                <svg width=""14px"" height=""15.2px"" viewBox=""0 0 36 36"" xmlns=""http://www.w3.org/2000/svg"">
                    <g id=""Lager_93"" data-name=""Lager 93"" transform=""translate(2 2)"">
                        <g id=""Sun_3_Brightness_3"" data-name=""Sun 3, Brightness 3"">
                            <path id=""Path_68"" data-name=""Path 68"" d=""M32,14H27.033c-2,1.769-.779,4,.967,4h4.967C34.966,16.231,33.746,14,32,14Z"" fill=""#fff""/>
    ...
    {
        var theme = _currentTheme == Theme.Dark ? "dark" : "light";
        var fileName = theme switch
        {
            "light" => "ant-design-blazor.aliyun.min",
            "dark" => "ant-design-blazor.dark.min",
            _ => null
        };
